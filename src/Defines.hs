...
addFunction env name params body = Env (defines env) (errors env) (functions env ++ [Function name params body])
...
registerFunction env name params body = addFunction env name (getParams params) body
